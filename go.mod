...
// Required by integration tests - use local origin for test utilities
replace github.com/openshift/origin => /Users/memodi/workspaces/repos/origin

// Required by integration tests - use OpenShift's kubernetes fork
replace (
